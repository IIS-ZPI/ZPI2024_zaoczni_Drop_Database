...
class Ui_MainWindow(object):
        ...
        def add_currency_icons(self):
                ...
                self.label_NOK_icon = QtWidgets.QLabel(self.widget)
        ...
        def add_checkboxes(self):
                ...
                self.checkBox_NOK = QtWidgets.QCheckBox(self.widget)
                self.checkBox_NOK.setFont(self.create_font("Leelawadee UI", 12, True, 75))
                self.checkBox_NOK.setObjectName("checkBox_NOK")
                self.gridLayout_3.addWidget(self.checkBox_NOK, 1, 2, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.checkBox_NOK.setText(_translate("MainWindow", "NOK"))
