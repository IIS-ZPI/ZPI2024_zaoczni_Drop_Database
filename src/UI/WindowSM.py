...
class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
                ...
                self.radioButton_NOK = QtWidgets.QRadioButton(self.widget)
                ...
                self.radioButton_GBP = QtWidgets.QRadioButton(self.widget)
                font = QtGui.QFont()
                font.setFamily("Leelawadee UI")
                font.setPointSize(12)
                font.setBold(True)
                ...
                self.radioButton_USD = QtWidgets.QRadioButton(self.widget)
                font = QtGui.QFont()
                font.setFamily("Leelawadee UI")
                font.setPointSize(12)
                font.setBold(True)
                ...
                self.radioButton_EUR = QtWidgets.QRadioButton(self.widget)
                font = QtGui.QFont()
                font.setFamily("Leelawadee UI")
                font.setPointSize(12)
                font.setBold(True)
                ...
                self.label_SM.setStyleSheet("border-radius: 15px;\n"
                                                                        "background-color: rgb(5, 117, 189);")
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.label_SM2.setText(_translate("MainWindow", "Statistical measures"))
                self.label_SM.setText(_translate("MainWindow", "SM"))
